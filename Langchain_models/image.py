...
prompt_result = gemini.invoke("Generate a prompt for the image generation of room which contains all the resoures of human requiremnts (include everything)")
